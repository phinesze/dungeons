...
val enemyList = arrayOf(
        EnemyMold(name = "パリン", display = "Θ", abilityMap = AbilityMold(maxHp = 8, maxMp = 0, attack = 8, defense = 10, magicAttack = 10, magicDefense = 10, agility = 10).toAbilityMap(), levelAndExp = LevelAndExperience(level = 1, experience = 10)),
